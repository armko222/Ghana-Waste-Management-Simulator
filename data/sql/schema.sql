...
-- (These are ordinary DB indexes for query performance; they are
--  independent of, and do not substitute for, the custom BST/Red-Black/
--  B-tree structures required by Section 6 of the brief, which operate
--  on data loaded into memory.)
