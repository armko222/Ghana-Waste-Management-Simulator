...
/**
 * Owned by Issue #9. Implements SortAlgorithm so Issue #14's
...
public class QuickSort<T extends Comparable<T>> implements SortAlgorithm<T> {
    ...
    public void sort(T[] array) {
        throw new UnsupportedOperationException("TODO: Issue #9 \u2014 implement QuickSort, in place, ascending order.");
    }
}
